...
public class RectangleTest {
	...
	//	printRectangle(smallRectangle);
		...
		Rectangle bigRectangle = new Rectangle(300, 300);// constructor overloaing
	//	printRectangle(bigRectangle);

		Rectangle mediumRectangle=new Rectangle(200);
		//printRectangle(mediumRectangle);
		System.out.println("The total no of object created is"+Rectangle.count);
