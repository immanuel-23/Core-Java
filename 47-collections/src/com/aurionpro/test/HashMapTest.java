...
public class HashMapTest {
	public static void main(String args[]) {
		...
		HashMap<Integer,String>empNameClone=(HashMap<Integer, String>) empName.clone();// cloning hash maps
		...
		System.out.println("Enter your name:");
		name= sc.next();
		System.out.println("Enter your id"); // it doest not cereate a duplicate
		id=sc.nextInt();
		empName.put(id,name);
		System.out.println(empName);
